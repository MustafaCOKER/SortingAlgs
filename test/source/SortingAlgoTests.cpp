...
TEST(GnomeSort, PositiveNos)
{
    initTestArr();
    generateTestArr();

    gnomeSort(varArrIntD, TEST_ARR_SIZE, greaterThan_int, swap_int);
    gnomeSort(varArrCharD, TEST_ARR_SIZE, greaterThan_char, swap_char);
    gnomeSort(varArrDoubleD, TEST_ARR_SIZE, greaterThan_double, swap_double);
    gnomeSort(varArrFloatD, TEST_ARR_SIZE, greaterThan_float, swap_float);
