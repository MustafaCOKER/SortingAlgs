...
DEF_GREATER_THAN(char, greaterThan_double);
DEF_SWAP(char, swap_double);
DEF_PRINT(char, print_double, "%c ");
DEF_COMPARE_Nth_ITEMs_Of_2ARRAY(char, compareItems_double);

// definitions of required functions for float
DEF_GREATER_THAN(char, greaterThan_float);
DEF_SWAP(char, swap_float);
DEF_PRINT(char, print_float, "%c ");
DEF_COMPARE_Nth_ITEMs_Of_2ARRAY(char, compareItems_float);
